-- Duplicate "255 California" project
...
BEGIN
  ...
  -- Step 3: Duplicate element_instances
  INSERT INTO element_instances (
    id, assessment_id, element_group_id, label, created_at, updated_at,
    parameters, bounding_box, page_number
  )
  SELECT
    gen_random_uuid(), v_new_assessment_id, element_group_id, label,
    created_at, updated_at, parameters, bounding_box, page_number
