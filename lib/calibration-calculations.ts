 ...
 */
export function formatDistanceArchitectural(inches: number, precision: number = 1): string {
 ...
 */
export function formatDistanceMetric(inches: number, precision: number = 1): string {
