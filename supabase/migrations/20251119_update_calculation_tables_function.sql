-- Update get_assessment_calculation_tables function to use chapters → codes
...
'Fetches checks with calculation tables for an assessment. Uses chapters → codes relationship.';
