-- Fix bug where screenshots are not showing for violations in element instances
-- When an element instance (e.g. "Doors 12") has multiple checks for different code sections,
-- screenshots assigned to one check should be visible on all sibling checks
