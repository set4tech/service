-- Fix get_assessment_report to include element group screenshots for element instance checks
-- This ensures that violations for element-based checks (e.g., "Doors 36") show their screenshots
-- even when screenshots are only tagged with element_group_id and not assigned via screenshot_check_assignments
