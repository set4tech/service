...
describe('useAssessmentData', () => {
  ...
  it('should fetch consolidated assessment data', async () => {
    ...
    const { result } = renderHook(() =>
      useAssessmentData('assessment-1', 'project-1', 1, true)
    );
  ...
  it('should filter screenshots to current page', async () => {
    ...
    const { result } = renderHook(() =>
      useAssessmentData('assessment-1', 'project-1', 2, true)
    );
  ...
  it('should not fetch when disabled', async () => {
    const { result } = renderHook(() =>
      useAssessmentData('assessment-1', 'project-1', 1, false)
    );
  ...
  it('should include projectId and pageNumber in URL', async () => {
    ...
    const { result } = renderHook(() =>
      useAssessmentData('assessment-1', 'project-1', 3, true)
    );
