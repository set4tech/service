...
test.describe('PDF Measurements', () => {
  ...
  test.describe('Entering Measurement Mode', () => {
    test('should enter measurement mode with M key', async ({ page, waitForPDF }) => {
      ...
      const cursor = await viewport.evaluate(el => 
  ...
  test.describe('Measurement Calculations', () => {
    ...
    test('should update existing measurements when calibration changes', async ({ page, waitForPDF }) => {
      await waitForPDF();
  ...
  test.describe('Multiple Measurements', () => {
    test('should allow drawing multiple measurements on same page', async ({ page, waitForPDF }) => {
      await waitForPDF();
  ...
  test.describe('Measurement Mode with Screenshot Mode', () => {
    test('should exit measurement mode when entering screenshot mode', async ({ page, waitForPDF }) => {
      await waitForPDF();
    ...
    test('should exit screenshot mode when entering measurement mode', async ({ page, waitForPDF }) => {
      await waitForPDF();
  ...
  test.describe('Calibration Line Display', () => {
    test('should show calibration line when using known length method', async ({ page, waitForPDF }) => {
      await waitForPDF();
